...
<div class="container">
    <h1 class="text-center mb-3 mt-5">Update Cửa hàng</h1>
    <div class="d-flex justify-content-center">
        <div class="card w-50 d-flex justify-content-center">
            <div class="card-body">
                <form action="/cua-hang/update" method="post">
                    <input type="text" class="form-control" value="${ch.id}" name="id" style="display: none">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="${ch.quocGia}" name="quocGia">
                        <c:if test="${not empty errors}">
                            <span class="text-danger">${errors['quocGia']}</span>
                        </c:if>
                    </div>
                    <div class="text-center">
                        <a href="/cua-hang/list" class="btn btn-secondary">Back</a>
