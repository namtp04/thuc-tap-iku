...
<div class="container">
    <h1 class="text-center mb-3 mt-5">Create nhân viên</h1>
                ...
                <form action="/nhan-vien/add" method="post">
                    ...
                    <div class="row mb-3 mt-4">
                        ...
                        <div class="col-2 form-check">
                            <input type="radio" class="form-check-input ms-3" value="Nam" checked name="gioiTinh" ${nv.gioiTinh=="Nam"?"checked":""}>
                            <label class="form-check-label">Nam</label>
                        </div>
                        <div class="col-2 form-check">
                            <input type="radio" class="form-check-input" value="Nữ" name="gioiTinh" ${nv.gioiTinh=="Nữ"?"checked":""}>
                    ...
                    <div class="row mb-3 mt-4">
                        ...
                        <div class="col-3 form-check">
                            <input type="radio" class="form-check-input ms-3" value="1" checked name="trangThai" ${nv.trangThai==1?"checked":""}>
                            <label class="form-check-label">ADMIN</label>
                        </div>
                        <div class="col-3 form-check">
                            <input type="radio" class="form-check-input" value="0" name="trangThai" ${nv.trangThai==0?"checked":""}>
